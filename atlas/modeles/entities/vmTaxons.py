...
class VmTaxons(Base):
    ...
    attributs: Mapped[List["VmCorTaxonAttribut"]] = relationship("VmCorTaxonAttribut", back_populates="taxon")
    organisms: Mapped[List["VmCorTaxonOrganism"]] = relationship("VmCorTaxonOrganism", back_populates="taxon")
