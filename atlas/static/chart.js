    ...
    fetch(`${configuration.URL_APPLICATION}/api/area_chart_values/${areaID}`)
        ...
        .then((data) => {
            ...
            observations_by_taxonomic_group =
                data.observations_by_taxonomic_group;
            ...
            const threatenedSpeciesChartElement = document.getElementById(
            ...
            const threatenedByTaxoGroupElement = document.getElementById(
                "threatenedSpeciesByTaxoGroupChart",
            );
            if (threatenedByTaxoGroupElement) {
                threatenedByTaxoGroupChartConfig(
                    threatenedByTaxoGroupElement,
                    species_by_taxonomic_group,
                );
            }

            // Onglet provenance des données
            const biodiversityByTerritoryChartElement = document.getElementById(
            ...
            const observationsByTerritoryChartElement = document.getElementById(
