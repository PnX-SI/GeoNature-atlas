...
-- SELECT drop_foreign_tables('ref_nomenclatures');
...
-- SELECT drop_foreign_tables('ref_geo');
...
-- SELECT drop_foreign_tables('gn_synthese');
IMPORT FOREIGN SCHEMA gn_synthese
FROM SERVER geonaturedbserver INTO gn_synthese;

-- SELECT drop_foreign_tables('gn_sensitivity');
