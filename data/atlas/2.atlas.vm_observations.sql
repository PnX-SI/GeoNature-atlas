...
AS $function$
  ...
  BEGIN
    SELECT INTO isBlurred
      CASE
        WHEN ( nomenclatureCode = '1' AND areaTypeCode = 'M10' ) THEN true
        WHEN ( nomenclatureCode = '2' AND areaTypeCode = 'M10' ) THEN true
        WHEN ( nomenclatureCode = '3' AND areaTypeCode = 'M10' ) THEN true
