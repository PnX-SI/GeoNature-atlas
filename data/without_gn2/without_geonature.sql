...
(
    ...
    1800,
    1850,
    ST_SetSRID(ST_MakePoint(6.9156, 45.7823), 4326),
    st_transform(ST_SetSRID(ST_MakePoint(6.9156, 45.7823), 4326), 2154),
    '2024-09-05 11:45:00',
    'Sophie'
),
-- Observation 5 : Loup gris, sensible - diffusion département
(
    (select id_dataset FROM gn_meta.t_datasets WHERE dataset_name = 'Observations faune 2024'),
    ...
    980,
    1020,
    ST_SetSRID(ST_MakePoint(6.7890, 45.8456), 4326),
    st_transform(ST_SetSRID(ST_MakePoint(6.7890, 45.8456), 4326), 2154),
    '2024-12-01 16:30:00',
    'John'
);