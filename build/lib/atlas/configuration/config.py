...
SQLALCHEMY_DATABASE_URI = (
    "postgresql://gnatlas:ohth+ie3gob4oofu@db.paca.lpo-aura.org:5435/gnatlasbiodiv06"
)
...
# Nom de la structure
STRUCTURE = "LPO Provence-Alpes-Côte d'Azur"

# Nom de l'application
NOM_APPLICATION = "Atlas Biodiv'PACA"
...
MAP = {
    ...
    "SECOND_MAP": {
        ...
        "attribution": '&copy; <a href="https://www.ign.fr/">IGN</a>, <a href="https://www.parc-naturel-normandie-maine.fr/">Parc & Géoparc Normandie-maine</a>',
        "tileName": "Ortho IGN",
    },
    "ZOOM": 8,
...
AFFICHAGE_COUCHES_MAP = {
    ...
    "COM": {"label": "Mailles communes", "selected": False, "fillOpacity": 0.2},
    "M10": {"label": "Mailles 10 km", "selected": False, "fillOpacity": 0.6},
}
...
TEXT_LAST_OBS = "Les observations des 5 derniers jours |"
...
RANG_STAT = [
    {"phylum": ["Arthropoda", "Mollusca", "Annelida", "Cnidaria", "Platyhelminthes"]},
    {"phylum": ["Chordata"]},
]
...
GROUPES_STATUTS = [
    ...
    },
    {
        "label": "Région",
        "filters": [
            {"cd_type_statut": "LRR", "cd_sig": "INSEER93"}  # par exemple "INSEER52"
        ],
    },
    {
        "filters": [
            {"cd_type_statut": "ZDET", "cd_sig": "INSEED06"}  # par exemple "INSEED44"
        ]
    },
]
...
REMOTE_MEDIAS_URL = "https://geonature.paca.lpo-aura.org/api/media/taxhub/"
...
TAXHUB_URL = "https://geonature.paca.lpo-aura.org/api/taxhub/"
...
# TYPE_TERRITOIRE_SHEET = ["COM","EPCI","DEP","ZPS","SIC","ZSC","PN","PNR","RNN","RNR","MER"]
TYPE_TERRITOIRE_SHEET = ["COM", "EPCI", "PND", "PN", "PNR", "RNR", "ZSC", "ZPS", "MER"]
...
STATIC_PAGES = {
    ...
    "sciencesparticipatives": {
        ...
        "picto": "fa-eye",
        "order": 0,
        "template": "static/custom/templates/sciences-participatives.html",
    },
    "abc": {
        "title": "Atlas de la biodiversité communale",
        "picto": "fa-book",
        "order": 0,
        "template": "static/custom/templates/abc.html",
    },
}
...
SECRET_KEY = "waing>imohK3sahnie4Choh4c"
